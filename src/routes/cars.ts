...
router.post('/cars', asyncHandler(async (req: Request, res: Response) => {
...
router.put('/cars/:id', asyncHandler(async (req: Request, res: Response) => {
...
router.delete('/cars/:id', asyncHandler(async (req: Request, res: Response) => {
