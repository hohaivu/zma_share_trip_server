...
router.post('/trip-plans', asyncHandler(async (
...
router.get('/trip-plans', asyncHandler(async (req: Request, res: Response) => {
...
router.get('/trip-plans/:id', asyncHandler(async (req: Request, res: Response) => {
...
router.put('/trip-plans/:id', asyncHandler(async (
