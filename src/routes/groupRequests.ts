...
router.post('/group-requests', asyncHandler(async (req: Request, res: Response) => {
...
router.get('/group-requests', asyncHandler(async (req: Request, res: Response) => {
...
router.post('/group-requests/:id/cancel', asyncHandler(async (req: Request, res: Response) => {
